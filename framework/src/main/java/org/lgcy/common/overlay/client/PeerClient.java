...
import org.tron.common.overlay.server.LgcyChannelInitializer;
...
public class PeerClient {
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    LgcyChannelInitializer tronChannelInitializer = ctx
        .getBean(LgcyChannelInitializer.class, remoteId);
