...
This is the description of  Google Protobuf implementation of Lgcy's protocol.
...
- Lgcy has 3 `types` of account: Normal, AssetIssue, Contract
...
- Lgcy has 33 types of Contracts declared within [`Transaction`](#trans).
