...
public class LgcyNetService {
  ...
  public void start() {
    ...
    logger.info("LgcyNetService start successfully.");
  }
  ...
  public void stop() {
    ...
    logger.info("LgcyNetService closed successfully.");
  }
  ...
  protected void onMessage(PeerConnection peer, LgcyMessage msg) {
    try {
      switch (msg.getType()) {
  ...
  private void processException(PeerConnection peer, LgcyMessage msg, Exception ex) {
    ReasonCode code;
