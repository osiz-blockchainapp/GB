...
<!-- **Run Output:** -->
    ...
    Sending 10000 USDL to LSjfWSWcKCrJ1DbgMZSCbSqNK8DsEfqM9p
    Sending 10000 USDL to LHpWnj3dBQ5FrqW1KMVXXYSbHPtcBKeUJY
    Sending 10000 USDL to LWFTHaKdeHWi3oPoaBokyZFfA7q1iiiAAb
    Sending 10000 USDL to LFDGQo6f6dm9ikoV4Rc9NyTxMD5NNiSFJD
    Sending 10000 USDL to LDZZNigWitFp5aE6j2j8YcycF7DVjtogBu
    Sending 10000 USDL to LT8NRMcwdS9P3X9pvPC8JWi3x2zjwxZuhs
    Sending 10000 USDL to LBBJw6Bk7w2NSZeqmzfUPnsn6CwDJAXTv8
    Sending 10000 USDL to LVcgSLpT97mvoiyv5ChyhQ6hWbjYLWdCVB
    Sending 10000 USDL to LYjQd4xrLZQGYMdLJqsTCuXVGapPqUp9ZX
    Sending 10000 USDL to LHCw6hPZpFcLCWDcsZg3W77rXZ9rJQPncD
    ...
    (0) LSjfWSWcKCrJ1DbgMZSCbSqNK8DsEfqM9p (10000 USDL)
    (1) LHpWnj3dBQ5FrqW1KMVXXYSbHPtcBKeUJY (10000 USDL)
    (2) LWFTHaKdeHWi3oPoaBokyZFfA7q1iiiAAb (10000 USDL)
    (3) LFDGQo6f6dm9ikoV4Rc9NyTxMD5NNiSFJD (10000 USDL)
    (4) LDZZNigWitFp5aE6j2j8YcycF7DVjtogBu (10000 USDL)
    (5) LT8NRMcwdS9P3X9pvPC8JWi3x2zjwxZuhs (10000 USDL)
    (6) LBBJw6Bk7w2NSZeqmzfUPnsn6CwDJAXTv8 (10000 USDL)
    (7) LVcgSLpT97mvoiyv5ChyhQ6hWbjYLWdCVB (10000 USDL)
    (8) LYjQd4xrLZQGYMdLJqsTCuXVGapPqUp9ZX (10000 USDL)
    (9) LHCw6hPZpFcLCWDcsZg3W77rXZ9rJQPncD (10000 USDL)
...
```
 {"Welcome to":"LGCYGrid v2.2.8"}
```

## Docker Commands 
Here are some useful docker commands, which will help you manage the LGCY Quickstart Docker container on your machine. 
...
513078dc7816        lgcy                "./quickstart v2.0.0"   About an hour ago   Up About an hour    0.0.0.0:9090->9090/tcp, 0.0.0.0:18190->18190/tcp   lgcy
```  
...
```
  docker exec -it lgcy tail -f /lgcy/FullNode/logs/lgcy.log 
```
