 ...
 * msg factory.
 */
public class LgcyMessageFactory extends MessageFactory {

  private static final String DATA_LEN = ", len=";

  @Override
  public LgcyMessage create(byte[] data) throws Exception {
  ...
  private LgcyMessage create(byte type, byte[] packed) throws Exception {
