...
import org.tron.core.net.LgcyNetDelegate;
...
@Slf4j(topic = "net")
@Component
public class SyncBlockChainMsgHandler implements LgcyMsgHandler {

  @Autowired
  private LgcyNetDelegate tronNetDelegate;

  @Override
  public void processMessage(PeerConnection peer, LgcyMessage msg) throws P2pException {
