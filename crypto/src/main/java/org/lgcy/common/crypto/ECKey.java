...
import org.tron.common.crypto.jce.LgcyCastleProvider;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(LgcyCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = LgcyCastleProvider.getInstance();
  }
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(
        LgcyCastleProvider.getInstance(),
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(LgcyCastleProvider.getInstance())
