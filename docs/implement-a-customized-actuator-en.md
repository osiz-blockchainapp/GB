...
Meanwhile, register the new contract type in `Transaction.Contract.ContractType` emuneration within the `src/main/protos/core/Lgcy.proto` file. Important data structures, such as transactions, accounts and blocks, are defined in the `Lgcy.proto` file:
...
# or build via protoc
protoc -I=src/main/protos -I=src/main/protos/core --java_out=src/main/java  Lgcy.proto
...
public class SumActuatorTest {
  ...
  private LgcyApplicationContext context;
  ...
  public void init() {
    ...
    Args.setParam(new String[]{"--output-directory", dbPath},
            confFile);
    context = new LgcyApplicationContext(DefaultConfig.class);
...
INFO [net] LgcyNetService start successfully.
