...
import org.tron.core.exception.LgcyException;
...
public class Program {
  ...
  public static class Exception {
    ...
    public static PrecompiledContractException contractValidateException(LgcyException e) {
      return new PrecompiledContractException(e.getMessage());
    }

    public static PrecompiledContractException contractExecuteException(LgcyException e) {
      return new PrecompiledContractException(e.getMessage());
    }
