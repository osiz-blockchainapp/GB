...
import org.tron.common.application.LgcyApplicationContext;
...
import org.tron.core.net.LgcyNetService;
...
public class SolidityNode {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new LgcyApplicationContext(DefaultConfig.class);
    ...
    nodeManager.close();
    LgcyNetService tronNetService = context.getBean(LgcyNetService.class);
    tronNetService.stop();
